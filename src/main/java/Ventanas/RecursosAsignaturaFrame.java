...
public class RecursosAsignaturaFrame extends javax.swing.JFrame {
    
    /** Creates new form RecursosAsignaturaFrame */
    public RecursosAsignaturaFrame(String asignatura, ArrayList<RecursoDigital> materiales) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecursosAsignaturaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new RecursosAsignaturaFrame("Matemática", recursos).setVisible(true);
