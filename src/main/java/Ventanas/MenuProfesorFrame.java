...
public class MenuProfesorFrame extends javax.swing.JFrame {

    private Profesor docente;
    
    public MenuProfesorFrame(Profesor docente) {
        ...
        tablaCursos.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                if (fila != -1) {
                    String idCurso = (String) tablaCursos.getValueAt(fila, 0);
                    Curso cursoSeleccionado = buscarCursoPorId(idCurso);
                    //mostrarRecursosDelCurso(cursoSeleccionado);
                }
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuProfesorFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuProfesorFrame(prof).setVisible(true);
            }
        });
    }
